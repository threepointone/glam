...
var _sheet = __webpack_require__(3);

var _hash = __webpack_require__(2);
...
function toClass(cls, spec) {
  var hash = (0, _hash2.default)(spec);
  if (inserted[hash]) {
    return 'y-' + hash;
  }
  var src = spec.map(function (val, i) {
    return '--' + cls + '-' + i + ': ' + val;
  }).join(';');
  src = '.y-' + hash + ' {' + src + '}';
  inserted[hash] = true;
...
function css(className, dynamic) {
...
/* whowhowho */
var blue = 'blue'; // import React from 'react'
// import { render } from 'react-dom'

var cls = (0, _src2.default)('x-q55x9l', [blue]);

var cls2 = (0, _src2.default)('x-quveki', []);
